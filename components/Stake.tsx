import {
  ...
  export default function Stake() {
    ...
    return (
      <Card p={7} mt={12} bgGradient='linear(to-l,#1A365D,#B83280,#702459)'>
        <Heading fontSize='2xl' as='abbr' color='#CBD5E0'>Staking V1BIZ Token </Heading>
        <text fontSize='lg' fontWeight='800' color='#CBD5E0'>staking VBIZ and earn MBIZ </text>
